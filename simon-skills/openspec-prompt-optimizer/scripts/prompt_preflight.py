...
def simplicity(prompt_text: str) -> dict[str, Any]:
    ...
    if longest_line > 500:
        findings.append({"severity": "yellow", "id": "long_line", "message": "Prompt contains very long lines; review readability and truncation risk."})
...
def build_preflight_check(
    ...
    *,
    ...
    simple = simplicity(prompt_text)
    hardcoding = hardcoding_scan(prompt_text)
    overfit = anti_overfit(prompt_text)
